...
əhatə dairənizi genişləndirin və diqqəti şirkətinizə cəlb edin.`,
  ...
  },
  {
    ...
    name:"KEÇUP / MAYONEZ    ",
    title:"Burger, kartof qızartması və barbekü üçün və ya yeməkləri zərifləşdirmək üçün dadlı yoldaş. Ketçup və ya mayonez fərdi çapı ilə nəinki damağı sevindirir, həm də gözdə qalıcı təəssürat yaradır - 15 ml şüşələrdə hissələrdə.    ",
    Mehsul:["Məhsul: "," Pomidor ketçup / mayonez    "],
    Stikformati:["Format: ","Standart təqribən. 110 x 95 mm    "],
    Tezyig:["Təzyiq: ","Rəqəmsal çap - CMYK"],
    Xalis:["Qutunun içindəkilər: ","250 ədəd"],
    Icindeki:["İçindəkilər: ","Ketçup 15ml / Mayonez 15ml"],
    Material:["Material: ","Polyester / alüminium / PE kompozit film ağ"],
    Davamlilig:["Davamlılıq: ","Ketçup 9 ay / Mayonez 4 ay"],
    id:'7',
  },
